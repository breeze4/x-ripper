...
Ingested: 2026-08-10 — AGENTS.md rule added: verify x.com facts live before they land
...
Ingested: 2026-08-10 — no action — institutionalized: incremental harvest + GraphQL store-merge shipped in src/content.js, documented in docs/specs/2026-08-10-01-graphql-interceptor.md and README.md
...
Ingested: 2026-08-10 — no action — institutionalized: observed-thresholds fixture pattern baked into tools/README.md and tools/scenarios.json notes
...
Ingested: 2026-08-10 — no action — captured in persistent project memory (delegate-coding-to-affordable-model)
